...
than the tips of the particles. We attribute the asymptotic behavior of the
shift to a complete reaction of KCN with gold atoms. If more KCN was added to
the vial, the blue-shift would have continued.
...
\begin{figure}[htp]
 ...
 summarized in table \ref{tab:SEM_results}. }
 \label{fig:SEM}
\end{figure}
...
respectively for each of the cases. Table \ref{tab:SEM_results}
summarizes the average values found after analyzing approximately $300$
particles. The shift is rather small as compared to the standard deviation of
...
\begin{figure}[htp]
 ...
 peak appearing at $650\nm$ is attributed to Raman scattering from water.}
...
phenomenon that we attributed to enhanced Raman scattering close to the nano
particles.
