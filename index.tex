...
present in the experimental results. Figure \ref{fig:simulations}b shows the
...
each particle denote their volume (the smallest being $1.8\cdot10^4\nm^3$ and
the largest $8.4\cdot10^4\nm^3$. In this way it is possible to observe that
