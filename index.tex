...
{{\color{red} For the past decade, single-particle experiments have provided
insight into processes that would have been averaged out in bulk experiments.
For instance, pump and probe experiments on single-particles avoid the inclusion
of assumptions regarding size distributions of the
sample\cite{Hartland2006}\cite{Ruijgrok2012c}. Non linear processes as second
(or third) harmonic generation can be studied when the particles'
plasmon is well characterized and single-particle experiments allow to overcome
the inhomogeneous broadening of a sample in
...
Most of these experiments will benefit from techniques that allow to \textit{in
situ} tune the plasmon resonance and geometry of specific particles once they
